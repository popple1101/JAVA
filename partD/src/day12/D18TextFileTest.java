...
public class D18TextFileTest {
    ...
    public static void readByLine() {
        ...
        try {
            ...
            fr = new FileReader("C:\\Class250616\\java_workspace\\partD\\src\\0724_파일입출력.txt",
                    Charset.forName("UTF-8"));
            // 경로가 현재 폴더위치에 있는 파일. 경로 생략.
    ...
    public static void readText() {
        ...
        StringBuilder sb = new StringBuilder();
        try {
            fr = new FileReader("C:\\Class250616\\java_workspace\\partD\\text.txt");
