...
public class D17FileCopyPerformance {
  ...
  public static void main(String[] args) {
    ...
    // copyByByte(); // 799.4650894 초
    // 대용량 이미지 일때, 메소드에 입출력 단위 지정 vs 자바의 버퍼크래스를 사용
    // -> 성능 차이 있음.
    // copyByByteArray(); // 1.2961393 초
    copyByBufferStream(); // 0.3353941 초
    // 실행 종료한 시간 저장
  ...
  public static void copyByBufferStream() {
    ...
    BufferedInputStream bis = null; // 추가적인 버퍼를 활용한 입력 스트림
    BufferedOutputStream bos = null; // 추가적인 버퍼를 활용한 출력 스트림
    byte[] buffer = new byte[256];
    try {
      fis = new FileInputStream("C:\\Users\\C112\\Desktop\\test.tif");
      fos = new FileOutputStream("C:\\Users\\C112\\Downloads\\people1.tif");
  ...
  public static void copyByByteArray() { // 바이트배열을 이용하여 입출력단위를 개선
    ...
    try {
      ...
      int count = 0;
      fis = new FileInputStream("C:\\Users\\C112\\Desktop\\test.tif");
      fos = new FileOutputStream("C:\\Users\\C112\\Downloads\\people2.tif");
  ...
  public static void copyByByte() { // 바이트 단위로 복사
    ...
    try {
      ...
      int count = 0;
      fis = new FileInputStream("C:\\Users\\C112\\Desktop\\test.tif");
      fos = new FileOutputStream("C:\\Users\\C112\\Downloads\\people3.tif");
