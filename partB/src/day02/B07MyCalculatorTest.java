...
public class B07MyCalculatorTest {
    ...
    public static void main(String[] args) {
        ...
        // 지금 연습한 MyCalculator 클래스와 유사한 기능의 자바 클래스는 Math 가 있습니다.
        System.out.println("Math add : " + Math.addExact(data1, data2));
        System.out.println("Math sub : " + Math.subtractExact(data1, data2));
        System.out.println("Math mul : " + Math.multiplyExact(data1, data2));
        System.out.println("Math max : " + Math.min(data1, data2));
        System.out.println("Math min : " + Math.max(data1, data2));
    }
}
...
class MyCalculator {
    ...
    static int div(int num1, int num2) {
        if (num2 == 0) {
            ...
            return 0; // num2 가 0이면 임의의 값 0을 리턴
        }
