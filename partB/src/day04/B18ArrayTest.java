...
// jaja.lang 패키지 소속 : String, System, Integer와 같은 래퍼 클래스 등등
...
public class B18ArrayTest {
    public static void main(String[] args) {
        ...
        System.out.println("arr1 : " + arr1); // arr1 : [I@4517d9a3 에서 [I Int 배열 / 메모리의 주소
        System.out.println("arr1 : " + arr2);

        double[] darr1 = { 3.4, 5, 8.8, 1.23, 9.99 };
        double[] darr2 = { 3.4, 5, 8.8, 1.23, 9.99 };
        System.out.println("darr1 : " + darr1); // darr1 : [D@85ede7b
        System.out.println("darr2 : " + darr2); // darr1 : [D@85ede7b

        // 배열의 기본속성 (메소드 아님)
        System.out.println("arr1 길이 : " + arr1.length); // 5
        System.out.println("arr1 길이 : " + arr2.length); // 10

        // 배열요소는 인덱스로 지정합니다. 인덱스 0 부터 시작.
        ...
        int[] newArr1 = Arrays.copyOf(arr2, 3);
        ...
        // Arrays 의 메소드 중에서 fill, sort는 리턴타입이 void 이며. 배열의 요소겂들을 변경
